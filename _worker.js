...
- **쉬운 설명 원칙**: 전문 용어(천간, 지지, 십성 등)를 사용할 때는 반드시 쉬운 비유나 일상적인 예시로 풀어서 설명하세요. 예: "편관(偏官)은 회사에서의 상사나 경쟁자 같은 에너지입니다."
- **시각적 표현**: 각 섹션에 관련 이모지를 풍부하게 사용하세요 (🌳🔥⛰️🪙💧 오행, ☀️🌙 음양, ⭐💫🌟 귀인 등). 각 소제목과 핵심 포인트마다 이모지를 넣어주세요.
- **비유와 이야기**: 딱딱한 해설 대신 "당신은 마치 봄바람처럼..." 같은 비유적이고 감성적인 문체를 사용하세요.
- **핵심 요약 박스**: 각 섹션 시작에 핵심 한줄 요약을 > 인용구 형태로 제공하세요. 예: > 🌟 한마디로: 당신은 불꽃처럼 뜨거운 열정의 소유자입니다!
- **보고서 형식 (필수)**:
...
**본 분석**
1. **🏛️ 사주 기둥의 핵심 하이라이트**: 사주 기둥(년주·월주·일주·시주)를 한자+한글로 정확하게 표기하고, 각 기둥이 인생에서 어떤 의미인지 쉽게 비유해주세요. 예: "년주는 당신의 뿌리이자 가문의 기운입니다."
2. **🌿🔥⛰️🪙💧 오행(목·화·토·금·수) 분석**: 각 오행을 자연 현상에 비유하며 설명하세요. 강약, 균형, 보완 요소를 자세히 설명하고, 반드시 "🌿목 N개, 🔥화 N개, ⛰️토 N개, 🪙금 N개, 💧수 N개" 형태로 정리한 후 바로 설명하세요.
3. **☯ 음양(陰陽) 분석**
...
전체 섹션을 최소 20문장, 800자 이상으로 풍부하게 작성하세요.
6. **🗓️ 대운(大運) 분석 - 인생의 큰 흐름**: 현재 대운 시기(${daeunYears})와 향후 주요 대운 전환기를 명시하고, 각 시기별 운세 흐름과 주의사항을 자세히 알려주세요.
7. **🎭 성격과 재능 - 나는 어떤 사람일까?**: 일간(${calculatedSaju ? calculatedSaju.dayStem : ''})의 오행 특성, 십성 배치, 12운성이 나타내는 성격과 재능을 반드시 15~20문장, 500자 이상으로 자세히 분석해주세요. 장점과 단점 모두 포함하세요.
8. **💑 관계/대인관계 - 사람과의 인연**: 십성 관계에서 드러나는 대인관계 패턴, 어울리는 사람의 오행 특성, 연애/결혼/우정 각각의 특징을 반드시 15~20문장, 500자 이상으로 상세히 설명하세요.
9. **💼💰 직업/재물운 - 돈과 일의 흐름**: 적성 분야(오행/십성 기반), 재물 유형(정재/편재), 투자 성향, 시기에 맞는 재무 전략을 반드시 15~20문장, 500자 이상으로 제공하세요.
10. **🏥 건강운 - 몸과 마음의 균형**: 오행의 과불급에 따른 취약 장기, 체질 특성, 계절별/나이별 건강 관리법을 반드시 15~20문장, 500자 이상으로 상세히 제공하세요.
11. **📅 시기별 운세 흐름 - 앞으로의 운세 달력**: 올해, 내년, 향후 5년의 운세 흐름과 주요 전환점을 반드시 15~20문장, 500자 이상으로 자세히 알려주세요.
